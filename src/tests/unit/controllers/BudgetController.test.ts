...
describe("BudgetController.getAll", ()=> {
  ...
  it("should handle errors when fetching budgets", async () => {
    ...
    expect(res._getJSONData()).toStrictEqual({error: "Error en la respuesta"})
...
describe("BudgetController.create", () => {
  ...
  it("Should handle budget creation error", async () => {
    ...
    const data = res._getJSONData()
    expect(res.statusCode).toBe(500)
    expect(data).toEqual({error:"Error en la respuesta"})
...
describe("BudgetController.updateById", () => {
  it("should update the budget and return a success message", async () => {
    ...
    expect(res.statusCode).toBe(200)
    expect(data.message).toEqual("Presupuesto actualizado con éxito")
...
describe("BudgetController.deleteById", () => {
  it("should delete the budget and return a success message", async () => {
    ...
    expect(res.statusCode).toBe(200)
    expect(data.message).toEqual("Presupuesto eliminado con éxito")
